-- Autor       : erick
-- Fecha        : 2026-06-07
-- Descripción  : Sinónimos lógicos de transparencia para el nodo eambdd_s2.
--                 Expone fragmentos como <tabla>_f<n> y réplicas como
--                 <tabla>_r<n> para ocultar la ubicación física.

whenever sqlerror exit rollback;

prompt   Creando sinónimos lógicos en eambdd_s2

create or replace synonym tipo_procesador_r1      for tipo_procesador_r_eam_s2;
...
create or replace synonym tipo_tarjeta_video_r1   for tipo_tarjeta_video_r_eam_s2;
...
create or replace synonym tipo_almacenamiento_r1  for tipo_almacenamiento_r_eam_s2;
...
create or replace synonym tipo_monitor_r1         for tipo_monitor_r_eam_s2;
...
create or replace synonym sucursal_f2             for sucursal_f2_eam_s2;
...
create or replace synonym sucursal_taller_f2      for sucursal_taller_f2_eam_s2;
...
create or replace synonym sucursal_venta_f2       for sucursal_venta_f2_eam_s2;
...
create or replace synonym laptop_f2               for laptop_f2_eam_s2;
...
create or replace synonym historico_status_laptop_f1 for historico_status_laptop_f1_eam_s2;
...
create or replace synonym servicio_laptop_f2      for servicio_laptop_f2_eam_s2;
